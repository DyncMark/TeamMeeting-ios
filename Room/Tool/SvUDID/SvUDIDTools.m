...
/***
 1:先创建KeychainAccessGroups.plist 放到项目的一级目录下，该字典的定级键为：keychain-access-groups
 然后是里面的值为字符串：格式为 开发者的App Identifier前十位.com.avcon.WideP2PVideo
 2:在build Settings 里面 Code Signing Entitlements 把该文件指引
 ****/
